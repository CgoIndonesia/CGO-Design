<template>
  <b-navbar class="navbar fixed-top navbar-dark" toggleable="lg" style="background-color:#233E98;color:#ffffff:padding:0 10% 0 10%">
      ...
      <b-collapse id="nav-collapse" is-nav style="padding:0 30px 0 0">
        ...
        <!-- Right aligned nav items -->
          ...
          <b-navbar-nav class="ml-auto pr-6">
            <b-nav-item href="/Home/register">Register</b-nav-item>
            ...
            <b-row>
                ...
                <b-col md="6" style="text-align:left;">
                  ...
                  <b-link href="www.twitter.com"><img src="@/assets/img/Color.png" style="margin:5px"></b-link>
                </b-col>
            </b-row>
          </b-dropdown>
            <b-col>
              <b-button size="sm" variant="danger" @click="onClick" style="border-radius:5px;width:150px;margin-top:3px">for merchant</b-button>
            </b-col>
        </b-navbar-nav>
    </b-collapse>
  </b-navbar>
