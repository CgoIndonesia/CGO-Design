                ...
                <b-card class="mr-4">
                  <div class="d-flex">
                    ...
                    <div class="pl-3">
                      ...
                      <p style="font-family: NunitoSans-Regular;">{{ sailingDetail.origin }} {{ sailingDetail.date }}</p>
                    </div>
                  </div>
                </b-card>
                <b-card>
                  <div class="d-flex">
                    ...
                    <div class="pl-3">
                      ...
                      <p style="font-family: NunitoSans-Regular;">{{ sailingDetail.destination }} {{ sailingDetail.end_date }}</p>
                    </div>
                  </div>
                </b-card>
              </div>
